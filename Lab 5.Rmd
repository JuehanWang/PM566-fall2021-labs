...
station_averages_rep[-c(1:9,11:14), c("USAFID","STATE","eudist_sum")]
```
...
station_midpoint[, c("USAFID","STATE","eudist_lat_lon")]
```

Finally, we get the station that is closest to the mid-point of the state.
